...
from proemb.utils.hmm_util import get_seq_hmm_probabilities_for_hsp, get_combined_seq_hmm_probabilities
...
def main(args):
    ...
    train_loader = DataLoader(
        FoldHomologyDataset(dataset_pth=args.fold_data_path, data_split='training', alphabet=alphabet,
                            augment_prob=args.augment_prob, noise_type=args.noise_type, softmax_tmp=args.softmax_tmp,
