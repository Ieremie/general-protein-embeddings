...
def main(args):
    ...
    train_loader = DataLoader(
        EnzymeDataset(args.enzyme_data_path, split='train', alphabet=alphabet, augment_prob=args.augment_prob,
                      noise_type=args.noise_type, filter_dataset=args.filter_dataset, softmax_tmp=args.softmax_tmp,
                      dont_augment_prob=args.dont_augment_prob, hit_function=hit_function),
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dont_augment_prob', type=float, default=0, help='how much of the seq not to augment')
    ...
    parser.add_argument('--full_hmm_augment_hits', action='store_true', help='if using the full hmm hits to augment instead of a single one')
